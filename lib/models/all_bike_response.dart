...
AllBikeResponse allBikeResponseFromJson(String str) => AllBikeResponse.fromJson(json.decode(str));

String allBikeResponseToJson(AllBikeResponse data) => json.encode(data.toJson());
