...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    timeCtl1.clear();
    timeCtl2.clear();
    homeController.selectedHomeFilterStation = null;
    homeController.searchBikeProducts.clear();
  ...
  Future<void> _onRefresh() async {
    ...
    homeController.selectedHomeFilterStation = null;
    homeController.searchBikeProducts.clear();
    await homeController.fetchUserName();
    await homeController.getAllProductsHome();
    await homeController.fetchFilterDropDownData();
    await homeController.getAllStation();
  }
                  ...
                  SliverList(
                    delegate: SliverChildListDelegate(
                      [
                        ...
                        Obx(() {
                          return homeController.isFilter.value
                              ? CustomWidget.buildCustomGridView(
                                  context,
                                  homeController.filterBikeList,
                                  homeController.filterLoadingState.value)
                              : CustomWidget.buildCustomGridView(
                                  context,
                                  homeController.allBikeProducts,
                                  homeController.loadingState.value);
                        })
                      ],
                    ),
                  ),
